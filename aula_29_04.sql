...
#----------VIEWS---------#
CREATE OR REPLACE VIEW ListaAtacantesBrasileirao as 
SELECT * FROM JogadorBrasileiro
where posicao like 'Atacante';

select * from listaatacantesbraslileiros;

select nome, cpf from listaatacantesBrasileirao
where salario > 20000;

#--Descrevendo a visao criada--
desc ListaAtacantesBrasileirao;
...
insert into listaatacantesbrasileirao (cpf, nome, posicao, 
idEquipe, salario)
...
alter view listaatacantesbrasileirao as select nome, 
posicao from jogadorbrasileiro where posicao = 'Atacante';

drop view if exists listaatacantesbrasileirao;

create table listaatacantesbrasileirao as 
select * from jogadorBrasileiro where posicao like
'Atacante';

truncate table listaatacantesbrasileirao;

insert into listaatacantesbrasileirao
select * from jogadorbrasileiro where posicao like
'Atacante';
...
select * from jogadorbrasileiro where posicao like 
'Atacante';
select  * from listaatacantesbrasileirao;